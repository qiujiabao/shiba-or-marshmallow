...
const GOOGLE_CLOUD_STORAGE_DIR = 'https://storage.googleapis.com/shiba/';
const MODEL_FILE_URL = 'web_model/tensorflowjs_model.pb';
const WEIGHT_MANIFEST_FILE_URL = 'web_model/weights_manifest.json';
const INPUT_NODE_NAME = 'images';
//const OUTPUT_NODE_NAME = 'module_apply_default/MobilenetV2/Logits/output';
const OUTPUT_NODE_NAME = 'detection_classes';
